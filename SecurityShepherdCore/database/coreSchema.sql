...
INSERT INTO modules (`moduleId`, `moduleName`, `moduleType`, `moduleCategory`, `moduleResult`, `moduleHash`, `moduleStatus`, `incrementalRank`, `scoreValue`, `scoreBonus`, `hardcodedKey`) VALUES ('bb98de90cf5f2fbffd749c2c0768ff856932606b', 'Reverse Engineering 1', 'challenge', 'Mobile Reverse Engineering', 'christopherjenkins', 'c4a93f7d23c290ce3b8b82b229e639da38cbf8216aa58914fa8239f6ee2c3e31', 'open', '85', '50', '5', 1);
...
INSERT INTO modules (`moduleId`, `moduleName`, `moduleType`, `moduleCategory`, `moduleResult`, `moduleHash`, `moduleStatus`, `incrementalRank`, `scoreValue`, `scoreBonus`, `hardcodedKey`) VALUES ('62d19d1ef5e8329a2c02b86cb3b827cd14940a0a', 'Poor Authentication', 'lesson', 'Mobile Poor Authentication', 'UpsideDownPizzaDip', 'dd5d68df7597431644390059e7adb167aa873d9b3198d4c07a3ea5f85df3c649', 'open', '90', '50', '5', 1);																				
...
INSERT INTO modules (`moduleId`, `moduleName`, `moduleType`, `moduleCategory`, `moduleResult`, `moduleHash`, `moduleStatus`, `incrementalRank`, `scoreValue`, `scoreBonus`, `hardcodedKey`) VALUES ('1edc0f15239cec1028df7e3926661879f4b4c8d4', 'Unintended Data Leakage 1', 'challenge', 'Mobile Data Leakage', 'BagsofSalsa', '60125e0ab8fe27c03bef3ad82d133e8522f8fdffbd556d7ad179329cc038eab6', 'open', '130', '60', '5', 1);
...
INSERT INTO modules (`moduleId`, `moduleName`, `moduleType`, `moduleCategory`, `moduleResult`, `moduleHash`, `moduleStatus`, `incrementalRank`, `scoreValue`, `scoreBonus`, `hardcodedKey`) VALUES ('810ea26ec97336ca1169e07ca3c30d8aa1b1cab2', 'Unintended Data Leakage 2', 'challenge', 'Mobile Data Leakage', '627884736748', 'bd1a58e604988e0ac7bade34bb7d4239ae27f9dfddabfe340dfd1d92ad8b98d9', 'open', '140', '70', '5', 1);																																																													
...
INSERT INTO modules (`moduleId`, `moduleName`, `moduleType`, `moduleCategory`, `moduleResult`, `moduleHash`, `moduleStatus`, `incrementalRank`, `scoreValue`, `scoreBonus`, `hardcodedKey`) VALUES ('9c7814280ba5b91470e5f2a0f77ca35ba101482e', 'Poor Authentication 1', 'challenge', 'Mobile Poor Authentication', 'MegaKillerExtremeCheese', 'b46c42934f14896f9ee9e3b4c222e8bfa8048309a6fedd497265eacbb0a718a1', 'open', '160', '60', '5', 1);
...
INSERT INTO modules (`moduleId`, `moduleName`, `moduleType`, `moduleCategory`, `moduleResult`, `moduleHash`, `moduleStatus`, `incrementalRank`, `scoreValue`, `scoreBonus`, `hardcodedKey`) VALUES ('adc845f9624716eefabcc90d172bab4096fa2ac4', 'Failure to Restrict URL Access 3', 'challenge', 'Failure to Restrict URL Access', '8c1dbfdc7cad35a116535f76f21e448c6c7c0ebc395be2be80e5690e01adec18', 'e40333fc2c40b8e0169e433366350f55c77b82878329570efa894838980de5b4', 'open', '178', '90', '5', 0);
INSERT INTO modules (`moduleId`, `moduleName`, `moduleType`, `moduleCategory`, `moduleResult`, `moduleHash`, `moduleStatus`, `incrementalRank`, `scoreValue`, `scoreBonus`, `hardcodedKey`) VALUES ('4b34b93b499cc6064467f029b2b36d22f9183c4c', 'Broken Crypto 3', 'challenge', 'Mobile Broken Crypto', 'ShaveTheSkies', '21e54a43d40effddc5bd699c048868c71c73ac8f21c00b680d2fa31945ddda52', 'open', '180', '180', '70', 1);
...
CALL cheatSheetCreate('810ea26ec97336ca1169e07ca3c30d8aa1b1cab2', "To complete this challenge, connect the android debug bridge to the VM and run  adb logcat –d \<file location\> to dump logs to a text file. Trigger the key log by pressing the lotto button");
CALL cheatSheetCreate('1edc0f15239cec1028df7e3926661879f4b4c8d4', "To complete this challenge, start the app, go to the command line of the VM using ALT F1 and then navigate to /sdcard/, pictorial logs are places there. Connect adb to the device and run the adb pull command on the logs. ");
CALL cheatSheetCreate('9c7814280ba5b91470e5f2a0f77ca35ba101482e', "To complete this challenge, start the app, and login to get the key. you must login with an auth code. the code must be odd, must contain the numbers 2 and 4 and must be six digits long. previous codes may show up in a suggestion when typing the code in which will reveal this pattern.");
CALL cheatSheetCreate('bb98de90cf5f2fbffd749c2c0768ff856932606b', "To complete this challenge, find jarsigner which comes with the jdk and in a command line run the following:  jarsigner -verify -verbose -certs ReverseEngineer2.apk.");
CALL cheatSheetCreate('4b34b93b499cc6064467f029b2b36d22f9183c4c', "To complete this challenge, use adb pull to grab the key file and the key.db file from the app's /data/data/ directory. With the db password: Pa88w0rd1234 decrypt the database to get the key to the level. This will either require a small amount of coding or you can download and build sqlcipher. Finally there is an App on the playstore which can be used called SQLCipher Decrypt.");
CALL cheatSheetCreate('62d19d1ef5e8329a2c02b86cb3b827cd14940a0a', "To complete this challenge, you need to login to the App. The password reset function rquires two answers which can be gathered from the logs on the App. The answers are chicken and meade. This will reset the password to a six digit code and allow you to login and view the key.");
